...
public interface OpenStreetMapTileProviderConstants {
	...
	/**
	 * Maximum Zoom Level - we use Integers to store zoom levels so overflow happens at 2^32 - 1, but we also have a
	 * tile size that is typically 2^8, so (32-1)-8-1 = 22
	 */
	 ...
	 */
	public static final int CACHE_MAPTILECOUNT_DEFAULT = 9; // TODO default was 9

	/**
	 * number of tile download threads, conforming to OSM policy: http://wiki.openstreetmap.org/wiki/Tile_usage_policy
	 */
	public static final int NUMBER_OF_TILE_DOWNLOAD_THREADS = 2; // TODO default was 2
