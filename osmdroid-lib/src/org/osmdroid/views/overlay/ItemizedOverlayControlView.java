...
public class ItemizedOverlayControlView extends LinearLayout {
	...
	public ItemizedOverlayControlView(final Context context,
		...
		this(context, attrs, new ResourceProxy(context));
	}
	...
	public ItemizedOverlayControlView(final Context context,
		...
		this.mPreviousButton
				.setImageBitmap(pResourceProxy.getBitmap(ResourceProxy.previous));

		this.mNextButton = new ImageButton(context);
		this.mNextButton.setImageBitmap(pResourceProxy.getBitmap(ResourceProxy.next));

		this.mCenterToButton = new ImageButton(context);
		this.mCenterToButton.setImageBitmap(pResourceProxy.getBitmap(ResourceProxy.center));

		this.mNavToButton = new ImageButton(context);
		this.mNavToButton
				.setImageBitmap(pResourceProxy.getBitmap(ResourceProxy.navto_small));
