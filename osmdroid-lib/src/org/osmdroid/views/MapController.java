...
public class MapController implements IMapController, MapViewConstants {
    ...
    public void animateToForTracking(double latitude, double longitude, final double angleRad, final int offsset, boolean applyOffsset) {
        ...
        mOsmv.getScroller().startScroll(x, y, p.x - worldSize_2 - x, p.y - worldSize_2 - y, ANIMATION_DURATION_SHORT);
     ...
     * @param aDuration
     *            in Milliseconds. I.e.: {@link MapController.ANIMATION_DURATION_SHORT}, {@link MapController.ANIMATION_DURATION_DEFAULT},
    ...
    public void setCenter(final IGeoPoint point) {
        final Point p = TileSystem.LatLongToPixelXY(point.getLatitudeE6() * 1E-6, point.getLongitudeE6() * 1E-6, mOsmv.getZoomLevelFloor(), null);
    ...
    private abstract class AbstractAnimationRunner extends Thread {
        ...
        public AbstractAnimationRunner(final MapController mapViewController, final int aTargetLatitudeE6, final int aTargetLongitudeE6) {
            this(aTargetLatitudeE6, aTargetLongitudeE6, MapViewConstants.ANIMATION_SMOOTHNESS_DEFAULT, MapViewConstants.ANIMATION_DURATION_DEFAULT);
        }
    ...
    private class CosinusalBasedAnimationRunner extends AbstractAnimationRunner implements MathConstants {
        ...
        @SuppressWarnings("unused")
        public CosinusalBasedAnimationRunner(final int aTargetLatitudeE6, final int aTargetLongitudeE6, final float aStart, final float aRange,
    ...
    protected class HalfCosinusalDeceleratingAnimationRunner extends CosinusalBasedAnimationRunner implements MathConstants {
        ...
        protected HalfCosinusalDeceleratingAnimationRunner(final int aTargetLatitudeE6, final int aTargetLongitudeE6, final int aSmoothness,
                final int aDuration) {
