...
public final class TileSystem {
	...
	// int ret = mTileSize << levelOfDetail;
	// if (levelOfDetail - (int) levelOfDetail == 0.5f) {
	// int previous = ret;
	// int newSize = mTileSize << ((int) levelOfDetail + 1);
	// ret = previous + (newSize - previous) / 2097152;
	// Log.d("I Bike CPH", "previous = " + previous + " new = " + ret);
	// }
	// return ret;
	// }

	public static int MapSize(final float levelOfDetail) {
		int ret = (int) (mTileSize * Math.pow(2, levelOfDetail));// mTileSize << (int) levelOfDetail;
		return ret;
	}
	 ...
	 */
	public static GeoPoint PixelXYToLatLong(final int pixelX, final int pixelY, final int levelOfDetail, final GeoPoint reuse) {
	...
	public static GeoPoint PixelXYToLatLong(final int pixelX, final int pixelY, final float levelOfDetail, final GeoPoint reuse) {
		final GeoPoint out = (reuse == null ? new GeoPoint(0, 0) : reuse);
