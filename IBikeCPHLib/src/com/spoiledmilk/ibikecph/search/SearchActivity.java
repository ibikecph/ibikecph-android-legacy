...
public class SearchActivity extends Activity implements ScrollViewListener {
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		btnStart.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String st = "Start: " + textA.getText().toString() + " (" + ALatitude + "," + ALongitude + ") End: "
						+ textB.getText().toString() + " (" + BLongitude + "," + BLatitude + ")";
				...
				if (historyData != null)
					new DB(SearchActivity.this).saveSearchHistory(historyData, new HistoryData(fromName, ALatitude, ALongitude),
							SearchActivity.this);
	...
	public void onResume() {
		super.onResume();
		initStrings();
		if (textCurrentLoc.getVisibility() == View.VISIBLE && SMLocationManager.getInstance().getLastKnownLocation() != null) {
			ALatitude = SMLocationManager.getInstance().getLastKnownLocation().getLatitude();
			ALongitude = SMLocationManager.getInstance().getLastKnownLocation().getLongitude();
		}
