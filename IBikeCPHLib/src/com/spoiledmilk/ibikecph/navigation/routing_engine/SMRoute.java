...
public class SMRoute implements SMHttpRequestListener {
	...
	/*
	 * Decoder for the Encoded Polyline Algorithm Format https://developers.google
	...
	public void recalculateRoute(Location loc, boolean isBicycleTypeChanged) {
		...
		if (!isRouteBroken
				|| (isRouteBroken && (((pastTurnInstructions != null && pastTurnInstructions.contains(station1)) || loc
						.distanceTo(endStation) < loc.distanceTo(startStation))))) {
