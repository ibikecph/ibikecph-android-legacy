...
public class SMRouteNavigationActivity extends FragmentActivity implements View.OnTouchListener, View.OnClickListener {
	...
	RelativeLayout.LayoutParams paramsInstructionsMaxNormal = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, (int) (Util.getScreenHeight()));
	RelativeLayout.LayoutParams paramsInstructionsMaxMaximized = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, (int) (Util.getScreenHeight() - INSTRUCTIONS_TOP_MARGIN));
	RelativeLayout.LayoutParams paramsInstructionsMaxMinimized = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, (int) (Util.getScreenHeight()));
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		FrameLayout.LayoutParams rootParams = new FrameLayout.LayoutParams((int) (9 * Util.getScreenWidth() / 5), FrameLayout.LayoutParams.MATCH_PARENT);
		...
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams((int) Util.getScreenWidth() * 4 / 5, RelativeLayout.LayoutParams.MATCH_PARENT);
		...
		RelativeLayout.LayoutParams paramsBtnTrack = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
	...
	public void onResume() {
		...
		String st = "Start: " + IbikeApplication.getString("current_position") + " (" + mapFragment.startLocation.getLatitude() + "," + mapFragment.startLocation.getLongitude() + ") End: " + mapFragment.destination + " (" + mapFragment.endLocation.getLatitude() + "," + mapFragment.endLocation.getLongitude() + ")";
	...
	private class PagerListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			if (!instructionsUpdated || (mapFragment.isRecalculation && !mapFragment.getTrackingMode())) {
				...
				if (turn.drivingDirection == SMTurnInstruction.TurnDirection.ReachedYourDestination || turn.drivingDirection == SMTurnInstruction.TurnDirection.ReachingDestination) {
