...
public class ProfileActivity extends Activity implements ImagerPrefetcherListener {
	...
	public void onCreate(final Bundle savedInstanceState) {
			...
			public void onClick(View arg0) {
				if (userData != null && userData.getName() != null && textName.getText() != null)
					if (!userData.getName().equals(textName.getText().toString())
							...
							|| (!textNewPassword.getText().toString().equals(userData.getPassword()) && !textNewPassword.getText()
									.toString().equals(""))) {
						launchBackDialog();
					} else {
						finish();
		...
		userData = new UserData(PreferenceManager.getDefaultSharedPreferences(ProfileActivity.this).getString("auth_token", ""),
				PreferenceManager.getDefaultSharedPreferences(ProfileActivity.this).getInt("id", -1));
